...
oosDF <- oosDF %>% 
  calcTrueMeansAndPOs(indf = .,
                      widen = FALSE,
                      trt_options_stage1 = metadata$firstLineTreatments,
                      trt_options_stage2 = metadata$secondLineTreatments,
                      outcome_function_stage1 = args$generateY1_fn,
                      outcome_function_stage2 = args$generateY2_fn,
                      outcome_function_final = args$generateY_fn,
                      outcome_args_stage1 = args$generateY1_args,
                      outcome_args_stage2 = args$generateY2_args,
                      outcome_args_final = args$generateY_args,
                      assign_responder_fn = args$assignResponderStatus_fn,
                      assign_responder_args = args$assignResponderStatus_args)

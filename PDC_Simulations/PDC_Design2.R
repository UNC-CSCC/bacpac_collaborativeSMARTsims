...
if (run_sim_flag == TRUE){
  ...
  toc()
} else{ sim_data_list <- readRDS("sim_data_list_design2.RDS")}

if (save_sim_data_flag == TRUE) saveRDS(sim_data_list, "sim_data_list_design2.RDS")
...
if (run_analysis_flag == TRUE) {
  ...
  analysis_results <- readRDS("design2_analysis.rds")
}
if (save_analysis_flag == TRUE) saveRDS(analysis_results, "design2_analysis.rds")

...
stage1_param_df <- read.csv("./ParameterCSVs/NoSubgroups-ATEscenario1/no_subgroups_stage1.csv")

stage1_param_vec <- stage1_param_df$Coefficient
names(stage1_param_vec) <- stage1_param_df$Parameter

stage2_param_df <- read.csv("./ParameterCSVs/NoSubgroups-ATEscenario1/no_subgroups_stage2.csv")
...
stage1_args <- list( stage.suffix = 1,
                     treatment.arm.df = stage_1_trts <- tibble(A1 = as.character(0:3),
                                                               ...
                                                               A1_3 = c(0, 0, 0, 1)),
                     arm.var.name = "A1",
                     true.model.formula = formula(~ 1 + W_1 + A1_1 + A1_2 + A1_3), 
...
stage2_args <- list(stage.suffix = 2,
                    ...
                    arm.var.name = "A2",
                    true.model.formula = formula(~ 1 + W_1 + A2_1 + A2_2 + A2_3 + A2_1:A2_2 + A2_1:A2_3 + A2_2:A2_3 ), 
...
analysis_args <- list(AnalysisModeling_fn = "QLearning",
                      AnalysisModeling_args = list(stage1.formula = formula(PseudoY ~ 1 + A1_1 + A1_2 + A1_3),
                                                   stage2.formula = formula(Y ~ 1 + Y1 + A2_1 + A2_2 + A2_3 + A2_1:A2_2 + A2_1:A2_3 + A2_2:A2_3),
...
if (FALSE) {
  ...
  m1 <- lm(Y ~ 1 +  A1_1 + A1_2 + A1_3 + A2_1 + A2_2 + A2_3 + A2_1:A2_2 + A2_1:A2_3 + A2_2:A2_3, data = s1)
  m1.simp <- lm(Y ~ Trt1 + Trt2 + Trt3 + A2_1:A2_2 + A2_1:A2_3 + A2_2:A2_3, data = s1)
  m1.2 <- lm(Y2 ~ 1 + A2_1 + A2_2 + A2_3 + A2_1:A1_1 + A2_1:A2_2 + A2_1:A2_3 + A2_2:A2_3, data = s1)
  m1.1 <- lm(Y1 ~ 1 + A1_1 + A1_2 + A1_3, data = s1)

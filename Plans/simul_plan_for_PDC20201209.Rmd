...
<p style="color:red"> Update on 8 December 2020. Ignore the code below. Please use the following:  
\begin{align*}
   \mathbb{E}[Y \vert H_2, A_2] =& 0.15I(A_1 = 1)X_1 - 0.15I(A_1 = 2)X_1 + 0.15I(A_2 = 3)
\end{align*} 

Note that $X_1 \in \{-1, 1\}$ and that Treatment 3 is always better at stage 2 (regardless of $X_1$). This doesn't push the non-opt DTRs to 0, but does push their value to 1/2 that of the optimal.
</p>
...
<p style="color:red"> Update on 8 December 2020. Ignore the code below. Please use the following:  
\begin{align*}
   \mathbb{E}[Y \vert H_2, A_2] =& 0.10I(A_1 = Trt\_1) + 0.20I(A_2 = Trt\_1)
\end{align*} 

Note that Treatment 1 is always dominant.
</p>
...
<p style="color:red"> Update on 8 December 2020. Ignore the code below. Please use the following:  
\begin{align*}
   \mathbb{E}[Y \vert H_2, A_2] =& 0.15I(A_1 = Trt\_1)X_1 - 0.15I(A_1 = Trt\_2)X_1 + 0.15I(A_2 = Trt\_3)
\end{align*} 
...
### Design 4 - 8 DECEMBER 2020 SKIP FOR NOW
...
<p style="color:red"> Update on 8 December 2020. Ignore the code below. Please use the following:  
\begin{align*}
   \mathbb{E}[Y \vert H_2, A_2] =& 0.15I(A_1 = Trt\_1) + 0.15I(Trt\_1 \in A_2)
\end{align*} 
...
<p style="color:red"> Update on 8 December 2020. Ignore the code below. Please use the following:  
\begin{align*}
   \mathbb{E}[Y \vert H_2, A_2] =& 0.3 W_1 + 0.3 W_2 + 0.3 W_3
\end{align*} 

Note that Treatment 1 is always dominant. To operationalize, I believe that you can create new treatments W_1 = agumented with 1 and W_2 = agumented with 2 and W_3 augmented with 3.
</p>
```{r, echo = TRUE, results = 'hide'}
# Coefficients to plug into Y (above)
beta0 <- c(beta00 = c(0, 0, 0),
...
<p style="color:red"> Update on 8 December 2020. Ignore the code below. Please use the following:  
\begin{align*}
   \mathbb{E}[Y \vert H_2, A_2] =& 0.3 W_1 X_1 + 0.3 W_2 X_1 + 0.3 W_3 X_1 -0.15 I(A_2 = 1) X_1 - 0.15 I(A_1 = 1) X_1 + 0.15 X_1
\end{align*} 
